 ...
 */
void
search_docs(gitsoo_env *env, search_results **results,
 ...
 */
int
split_query_to_tokens(gitsoo_env *env,
 ...
 */
void
print_search_results(gitsoo_env *env, search_results *results)
{
 ...
 */
void
search(gitsoo_env *env, const char *query)
{
    int query32_len;
    UTF32Char *query32;
