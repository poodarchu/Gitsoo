 ...
 */
int
init_database(gitsoo_env *env, const char *db_path)
{
    int rc;
 ...
 */
int
db_get_document_id(const gitsoo_env *env,
 ...
 */
int
db_get_document_title(const gitsoo_env *env, int document_id,
 ...
 */
int
db_add_document(const gitsoo_env *env,
                const char *title, unsigned int title_size,
 ...
 */
int
db_get_token_id(const gitsoo_env *env,
 ...
 */
int
db_get_token(const gitsoo_env *env,
             const int token_id,
 ...
 */
int
db_get_postings(const gitsoo_env *env, int token_id,
 ...
 */
int
db_update_postings(const gitsoo_env *env, int token_id, int docs_count,
 ...
 */
int
db_get_settings(const gitsoo_env *env, const char *key, int key_size,
 ...
 */
int
db_replace_settings(const gitsoo_env *env, const char *key,
                    int key_size,
                    const char *value, int value_size)
{
    int rc;
 ...
 */
int
db_get_document_count(const gitsoo_env *env)
{
    int rc;
