 ...
 */
static int
decode_postings(const gitsoo_env *env,
 ...
 */
static int
encode_postings(const gitsoo_env *env,
                const postings_list *postings, const int postings_len,
                buffer *postings_e)
{
    switch (env->compress) {
 ...
 */
int
fetch_postings(const gitsoo_env *env, const int token_id,
               postings_list **postings, int *postings_len)
{
    char *postings_e;
 ...
 */
void
update_postings(const gitsoo_env *env, inverted_index_value *p)
{
 ...
 */
void
dump_inverted_index(gitsoo_env *env, inverted_index_hash *ii)
{
