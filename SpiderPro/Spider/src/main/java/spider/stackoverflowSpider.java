...
public class stackoverflowSpider implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex(URL_LIST).match()) {
            ...
            page.putField("title", page.getHtml().xpath("//div[@id='question-header']/allText()").toString());
            page.putField("question", page.getHtml().xpath("//div[@class='post-text']/allText()").toString()+" ");
            page.putField("answer",page.getHtml().xpath("//div[@id='answers']/allText()").toString());
            page.putField("labels",page.getHtml().xpath("//div[@class='post-taglist']/allText()").toString());
            //page.putField("htmls",page.getHtml().xpath("//div[@id='content']").links().all());
